...
export const WarningModal = ({
  ...
  const handleConfirm = () => {
    confirmFunction(parameters); // Execute the function with the gameId
    closeModal();
  };
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-black p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    <WarningAmber style={{marginRight:"10px", color:"red"}}/>
                    Warning
                  </Dialog.Title>
                  <div className="warningContent"><WarningContent/></div>
